...
//////////////////////////////////////////////////////////////////////////
// AThirdPersonNeuronCharacter

AThirdPersonNeuronCharacter::AThirdPersonNeuronCharacter()
{
...
void AThirdPersonNeuronCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	if (FingerIndex == ETouchIndex::Touch1)
	{
		StopJumping();
...
void AThirdPersonNeuronCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AThirdPersonNeuronCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AThirdPersonNeuronCharacter::MoveForward(float Value)
{
...
void AThirdPersonNeuronCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
