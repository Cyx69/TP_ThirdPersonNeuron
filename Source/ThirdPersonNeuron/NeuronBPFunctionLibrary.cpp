...
#include "NeuronBPFunctionLibrary.h"
#include "ThirdPersonNeuronController.h"


// Init and read BVH reference skeleton
bool UNeuronBPFunctionLibrary::NeuronInit(AThirdPersonNeuronController *Controller, FString BVHFileName)
{
	if (Controller == NULL)
	{
		if (GEngine)
...
bool UNeuronBPFunctionLibrary::NeuronDisconnect(AThirdPersonNeuronController *Controller)
{
	if (Controller == NULL)
	{
		if (GEngine)
...
bool UNeuronBPFunctionLibrary::NeuronGetLocalBoneRotation(USkeletalMeshComponent *Mesh, FRotator& Rotation, int32 BoneIndex)
{
	if (Mesh == NULL)
	{
		if (GEngine)
...
FRotator UNeuronBPFunctionLibrary::NeuronNegateRotation(FRotator Rotation)
{
